...
export default function Builder(props) {
  ...
  const handleProfilePicture = (e) => {
    ...
    // Geçerli dosya türlerini kontrol edelim
    const validTypes = ["image/jpeg", "image/png", "image/jpg"];

    if (file && validTypes.includes(file.type)) {  // Dosya tipi kontrolü
        const reader = new FileReader();
        reader.onload = (event) => {
            setResumeData((prev) => ({ ...prev, profilePicture: event.target.result }));
        };
